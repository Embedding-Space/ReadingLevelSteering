...
VECTORS_PATH = Path("./onestop_output/complexity_vectors.pt")
# Llama 3.2 3B has 28 layers (0-27), use the final layer
STEERING_LAYER = 27
...
def run_experiment(model, tokenizer, complexity_vector):
    ...
    for strength in strengths:
        ...
        # Llama 3.2 uses different format than Qwen
        # Format is typically: <|start_header_id|>assistant<|end_header_id|>\n\nresponse
        if "<|start_header_id|>assistant<|end_header_id|>" in full_text:
            ...
            # Qwen format (shouldn't happen but keeping as fallback)
