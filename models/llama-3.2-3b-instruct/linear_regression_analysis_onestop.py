...
# Paths
CSV_PATH = Path("./onestop_output/steering_quantitative_results.csv")
OUTPUT_DIR = Path("./onestop_output")

# Analysis parameters
# Restrict to effective steering range based on OneStopEnglish results
# The sawtooth pattern shows excellent linearity on the NEGATIVE side only
ALPHA_MIN = -5.0
ALPHA_MAX = 0.0
