"""
Complexity Vector Extraction from OneStopEnglish Pairs

Extracts reading-level steering vectors by comparing activations from matched
pairs of Elementary and Advanced versions of the same news articles.

Experimental design:
- Load OneStopEnglish pairs (Elementary + Advanced on same topics)
- Model: Llama 3.2 3B Instruct
- Capture activations at each layer for both Elementary and Advanced versions
- Compute complexity_vector = mean(advanced) - mean(elementary)
...
DATA_PATH = Path("../../data/onestop_pairs/onestop_pairs.json")
OUTPUT_DIR = Path("./onestop_output")
SEED = 42
