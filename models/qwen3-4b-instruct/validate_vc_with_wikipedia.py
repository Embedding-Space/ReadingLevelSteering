#!/usr/bin/env python3
"""
Self-consistency check: Validate V_c against the Wikipedia data it was extracted from.

Hypothesis: Since V_c = mean(regular_activations) - mean(simple_activations),
feeding the same Wikipedia texts back should show strong correlation between
(activation · V_c) and actual FK grade.

If this FAILS, it suggests extraction/testing geometry mismatch.
If this SUCCEEDS but OneStop fails, it suggests overfitting to Wikipedia.
"""
...
def main():
    ...
    # Save results
    csv_path = OUTPUT_DIR / "wikipedia_validation_results.csv"
    ...
    ax.set_title(
        ...
        'Should show strong correlation if extraction/testing geometry matches',
        fontsize=13,
        fontweight='bold',
        pad=15
    )
    ...
    plt.tight_layout()
    plot_path = OUTPUT_DIR / "wikipedia_validation_analysis.png"
